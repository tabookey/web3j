    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        ...
                        + "    return staticGetTransferEvents(transactionReceipt);\n"
                        + "  }\n"
                        + "\n"
                        + "  public static java.util.List<TransferEventResponse> staticGetTransferEvents(org.web3j.protocol.core.methods.response.TransactionReceipt transactionReceipt) {\n"
